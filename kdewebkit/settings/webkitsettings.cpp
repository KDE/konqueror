...
void WebKitSettings::init( KConfig * config, bool reset )
{
  ...
  QWebSettings::globalSettings()->setFontSize(QWebSettings::MinimumFontSize, minFontSize() * 1.42);
  QWebSettings::globalSettings()->setFontSize(QWebSettings::DefaultFontSize, mediumFontSize() * 1.42);
}
